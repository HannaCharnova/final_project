...
) ENGINE=InnoDB AUTO_INCREMENT=255 DEFAULT CHARSET=utf8 COMMENT='Таблица предназначена для хранения информации о блюдах, которые готовятся в данном кафе, т.е. является своеобразным меню';
